...
local FunSection = FunTab:NewSection("Fun Scripts")

FunSection:NewButton("Load Flashlight", "Modded by Me, Tupoi", function() 
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Tupoi-Scripts/wrong_Hotel-Mode/refs/heads/main/FlashlightUpdated.lua"))() 
end)
 
MiscSection:NewButton("Custom Item, Guiding Candle", "...", function() 
